            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              ...
              <div className="space-y-5 md:col-span-1">
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center hover:bg-neon-blue/10 hover:text-neon-blue transition-all cursor-pointer">
          ...
          <div className="border-t border-white/5">
            <div className="mx-auto max-w-7xl px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-600">
              ...
              <p className="text-center">
                Built with ❤️ for Developers & SEO Specialists — Powered by Next.js
              </p>
